...
namespace SimpleCrypto
{
    public class SimpleBlowfish
    {
        ...
        public static byte[] Encrypt(byte[] data, byte[] key)
        {
            ...
            blowfish.Encipher(newData, newData.Length);
            return newData;
        }
        ...
        public static byte[] Decrypt(byte[] data, byte[] key)
        {
            Blowfish blowfish = new Blowfish(key);
            byte[] newData = (byte[])data.Clone();
            blowfish.Decipher(newData, newData.Length);
            return newData;
        }
        ...
        public static byte[] GetRandomKey(SimpleBlowfishKeyLength keyLength)
        {
            switch (keyLength)
            {
                case SimpleBlowfishKeyLength.Key32:
                    return _random.GetRandomBytes(32);
                case SimpleBlowfishKeyLength.Key64:
                    return _random.GetRandomBytes(64);
                case SimpleBlowfishKeyLength.Key128:
                    return _random.GetRandomBytes(128);
                case SimpleBlowfishKeyLength.Key256:
                    return _random.GetRandomBytes(256);
                case SimpleBlowfishKeyLength.Key448:
                    return _random.GetRandomBytes(448);
            }
    ...
    public enum SimpleBlowfishKeyLength
    {
        Key32,
        Key64,
        Key128,
